          ...
          <AccordionContent>
            <ul className="space-y-3">
              <li className="flex items-start">
                <span className="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">12'</span>
                <div>
              ...
              <li className="flex items-start">
                <span className="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">37'</span>
                <div>
                  <span className="font-semibold">Goal!</span> Mohamed Salah scores for {game.awayTeam}
                </div>
              </li>
              <li className="flex items-start">
                <span className="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">45+2'</span>
                <div>
                  <span className="font-semibold">Half Time</span>
                </div>
              </li>
              <li className="flex items-start">
                <span className="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">67'</span>
                <div>
        ...
        <AccordionItem value="pre-match-analysis">
          ...
          <AccordionContent>
            <div className="space-y-3 text-gray-700">
              <p>
                The rivalry between {game.homeTeam} and {game.awayTeam} is one of the most storied in English football,
                with both teams having a rich history of competitive matches.
              </p>
              <p>
                {game.homeTeam} comes into this match after a string of impressive performances, having won their last
                three league games. Their attacking trio has been in excellent form, contributing to 8 goals in those
                matches.
              </p>
              <p>
                {game.awayTeam}, on the other hand, has had mixed results in recent weeks but remains a formidable
                opponent. Their solid defensive record this season makes them difficult to break down, having conceded
                only 12 goals in 15 matches.
              </p>
              <p>
                The key battle to watch will be between {game.homeTeam}'s midfield maestro Bruno Fernandes and{" "}
                {game.awayTeam}'s defensive anchor Fabinho. Whoever wins this duel could well determine the outcome of
                the match.
              </p>
            </div>
          </AccordionContent>
